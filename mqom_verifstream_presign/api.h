...
#define CRYPTO_PRESIGNBYTES ((long) MQOM2_PRESIG_SIZE)
...
/*************************************************
* Name:        crypto_sign_prepare
*
* Description: Computes a pre-signature, independent of the signed message.
*
* Arguments:   - uint8_t *presig:   pointer to output pre-signature (of length CRYPTO_PRESIGNBYTES)
*              - size_t *presiglen: pointer to output length of pre-signature
*              - uint8_t *sk:       pointer to bit-packed secret key
*
* Returns 0 (success)
**************************************************/
...
/*************************************************
* Name:        crypto_sign_signature_finalize
*
* Description: Computes signature using a pre-signature.
*
* Arguments:   - uint8_t *sig:      pointer to output signature (of length CRYPTO_BYTES)
*              - size_t *siglen:    pointer to output length of signature
*              - uint8_t *m:        pointer to message to be signed
*              - size_t mlen:       length of message
*              - uint8_t *presig:   pointer to output pre-signature (of length CRYPTO_PRESIGNBYTES)
*              - size_t presiglen:  length of pre-signature
*              - uint8_t *sk:       pointer to bit-packed secret key
*
* Returns 0 (success)
**************************************************/
...
/*************************************************
* Name:        crypto_sign_finalize
*
* Description: Compute signed message using a pre-signature.
*
* Arguments:   - uint8_t *sm: pointer to output signed message (allocated
*                             array with CRYPTO_BYTES + mlen bytes),
*                             can be equal to m
