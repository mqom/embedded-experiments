...
#define gf256_gf256_mat_mult_tri_ref gf256_mat_mult_tri_ref
/**/
...
#define gf256_gf256_mat_mult_tri_avx2 gf256_mat_mult_tri_avx2
/**/
...
#define gf256_gf256_mat_mult_tri_avx512 gf256_mat_mult_tri_avx512
...
#define _field_ext_mat_mult_tri concat3(FIELD_EXT_PREFIX, _mat_mult_tri_, FIELD_IMPLEMENTATION_SUFFIX)
...
#define _field_ext_base_mat_mult_tri concat5(FIELD_EXT_PREFIX, _, FIELD_BASE_PREFIX, _mat_mult_tri_, FIELD_IMPLEMENTATION_SUFFIX)
...
/* XXX: NOTE: dedicated to triangular "compact" matrices */
static inline void field_ext_mat_mult_tri(const field_ext_elt *A, const field_ext_elt *X, field_ext_elt *Y, uint32_t n, matrix_type mtype) {
	_field_ext_mat_mult_tri(A, X, Y, n, mtype);
	return;
}
...
/* XXX: NOTE: dedicated to triangular "compact" matrices */
static inline void field_ext_base_mat_mult_tri(const field_ext_elt *A, const field_base_elt *X, field_ext_elt *Y, uint32_t n, matrix_type mtype) {
	_field_ext_base_mat_mult_tri(A, X, Y, n, mtype);
	return;
}
