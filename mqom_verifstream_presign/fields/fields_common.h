...
/* Exploit the "compact" form of A */
#define GF256_MAT_MULT_TRI(A, X, Y, n, mtype, fun) do { \
        uint32_t i; \
        switch(mtype){ \
                case REG:{ \
			/* XXX: Unsupported */ \
...
/* Exploit the "compact" form of A */
/* XXX: TODO: for now, TRI_SUP is unsupported as the leftover bits in the bytes
 * are somehow tedious to extract. This is left for future work to optimize 
 * this. */
#define GF256_GF2_MAT_MULT_TRI(A, X, Y, n, mtype, fun) do { \
        uint32_t i; \
        switch(mtype){ \
	        case TRI_SUP: \
                case REG:{ \
...
#define GF256to2_MAT_MULT_TRI GF256_MAT_MULT_TRI
#define GF256to2_GF2_MAT_MULT_TRI GF256_GF2_MAT_MULT_TRI
#define GF256_GF4_MAT_MULT_TRI GF256_GF2_MAT_MULT_TRI
#define GF256to2_GF4_MAT_MULT_TRI GF256_GF2_MAT_MULT_TRI
#define GF256_GF16_MAT_MULT_TRI GF256_GF2_MAT_MULT_TRI
#define GF256to2_GF16_MAT_MULT_TRI GF256_GF2_MAT_MULT_TRI
