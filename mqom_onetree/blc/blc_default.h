...
#define BLC_CheckChallenge_default MQOM_NAMESPACE(BLC_CheckChallenge_default)
...
static inline int BLC_CheckChallenge_default(const uint16_t i_star[MQOM2_PARAM_TAU]) { (void) i_star; return 0; }
