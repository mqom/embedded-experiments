...
#define BLC_CheckChallenge_memopt MQOM_NAMESPACE(BLC_CheckChallenge_memopt)
...
static inline int BLC_CheckChallenge_memopt(const uint16_t i_star[MQOM2_PARAM_TAU]) { (void) i_star; return 0; }
