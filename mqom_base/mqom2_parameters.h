...
/* === Trade-off "Faster" === */
#elif MQOM2_PARAM_TRADEOFF == 2
#else
#error "Sorry, unsupported trade-off: must be one of 'short', 'fast', 'faster'"
#endif
...
#elif MQOM2_PARAM_TRADEOFF == 2
#if MQOM2_PARAM_NBROUNDS == 3
#include "parameters/mqom2_parameters_cat1-gf16-faster-r3.h"
#elif MQOM2_PARAM_NBROUNDS == 5
#include "parameters/mqom2_parameters_cat1-gf16-faster-r5.h"
#endif
#endif
#elif MQOM2_PARAM_BASE_FIELD == 8
#if MQOM2_PARAM_TRADEOFF == 1
...
#elif MQOM2_PARAM_TRADEOFF == 2
#if MQOM2_PARAM_NBROUNDS == 3
#include "parameters/mqom2_parameters_cat3-gf16-faster-r3.h"
#elif MQOM2_PARAM_NBROUNDS == 5
#include "parameters/mqom2_parameters_cat3-gf16-faster-r5.h"
#endif
#endif
#elif MQOM2_PARAM_BASE_FIELD == 8
#if MQOM2_PARAM_TRADEOFF == 1
...
#elif MQOM2_PARAM_TRADEOFF == 2
#if MQOM2_PARAM_NBROUNDS == 3
#include "parameters/mqom2_parameters_cat5-gf16-faster-r3.h"
#elif MQOM2_PARAM_NBROUNDS == 5
#include "parameters/mqom2_parameters_cat5-gf16-faster-r5.h"
#endif
#endif
#elif MQOM2_PARAM_BASE_FIELD == 8
#if MQOM2_PARAM_TRADEOFF == 1
